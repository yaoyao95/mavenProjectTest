...
import thread.pool.queue.core.Reject;
import thread.pool.queue.core.ResizableSemaphore;
 ...
 * @since 13.0.0
 */
public class ResizableLinkedBlockingQueue<E> extends LinkedBlockingQueue<E> implements ResizableBlockingQueue<E>{
     ...
     */
    @Override
    public synchronized void setCapacity(int newSize) throws IllegalArgumentException {
        if (newSize < 0) {
